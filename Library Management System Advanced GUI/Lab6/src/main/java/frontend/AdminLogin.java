...
public class AdminLogin extends javax.swing.JFrame implements Node {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String usernameOriginal = LoginCredentials.ADMIN_USERNAME;
        String passOriginal = LoginCredentials.ADMIN_PASSWORD;
        
        if (usernameEntered.equals(usernameOriginal) && passEntered.equals(passOriginal)) {
            if(adminRole == null) {
                adminRole = new AdminRoleF();
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // TODO add your handling code here:
        this.setVisible(false);
        LibrarySystem l = (LibrarySystem) this.getParentNode();
        l.setVisible(true);
